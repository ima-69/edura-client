...
export const TeacherRegister: React.FC<TeacherRegisterProps> = ({ 
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.mobile.trim()) {
      ...
      newErrors.mobile = 'Invalid mobile number format (e.g., 0771234567)';
    }

    if (!formData.nic.trim()) {
      newErrors.nic = 'National Identity Card number is required';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-2xl p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Teacher Registration</h2>
